...
load("~/hdrive/GitHub/ballistic-movement/sim_results/sensitivity/supplementary/data/30000g_vary_patches_details.Rda")
...
load('~/hdrive/GitHub/ballistic-movement/sim_results/sensitivity/supplementary/data/30000g_vary_interval_details.Rda')
...
load('~/hdrive/GitHub/ballistic-movement/sim_results/sensitivity/supplementary/data/30000g_vary_interval_tracks.Rda')
mass_int <- 30000
...
load('~/hdrive/GitHub/ballistic-movement/sim_results/sensitivity/supplementary/data/30000g_vary_kcal_per_patch.Rda')
patch_results_df <- bind_rows(patch_results)

load('~/hdrive/GitHub/ballistic-movement/sim_results/sensitivity/supplementary/data/30000g_vary_kcal_per_patch2.Rda')
...
load("~/hdrive/GitHub/ballistic-movement/sim_results/sensitivity/supplementary/data/100g_vary_k.Rda")
patch_results_df <- do.call(rbind, patch_results)
...
load('~/hdrive/GitHub/ballistic-movement/sim_results/sensitivity/supplementary/data/100g_vary_interval_details.Rda')
...
load('~/hdrive/GitHub/ballistic-movement/sim_results/sensitivity/supplementary/data/100g_vary_kcal_per_patch2.Rda')
patch_results_df <- bind_rows(patch_results)

load('~/hdrive/GitHub/ballistic-movement/sim_results/sensitivity/supplementary/data/100g_vary_kcal_per_patch3.Rda')
patch_results_df2 <- bind_rows(patch_results)
...
load("~/hdrive/GitHub/ballistic-movement/sim_results/sensitivity/supplementary/data/5000000g_vary_k.Rda")
patch_results_df <- do.call(rbind, patch_results)
...
load('~/hdrive/GitHub/ballistic-movement/sim_results/sensitivity/supplementary/data/5000000g_vary_interval_details.Rda')
...
For the 5000000 gram individual, we used the same methods as previous analyses, with 240000 patches in the 95% HR area, with a sampling interval of $\frac{1}{40.5} * \tau_p$. We tested calorie per patch (kcal/patch) values from 0 to 6000, by 100 kcal increments. Based on these results, the lowest value of kcal/patch which produces viable offspring for this simulation setup is 2500 kcal/patch. The inconsistent results reveal that the value of kcal/patch will need to be scaled to the body mass.
...
load('~/hdrive/GitHub/ballistic-movement/sim_results/sensitivity/supplementary/data/5000000g_vary_kcal_per_patch.Rda')
patch_results_df <- bind_rows(patch_results)
