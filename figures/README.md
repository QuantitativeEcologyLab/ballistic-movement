...
* `03-clustering.png`: the results of resource clustering on movement strategy.
* `04-caloricvariance.png`: the result of patch value variance on movement strategy.
