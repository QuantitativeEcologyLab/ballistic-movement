...
for(G in 1:GENS) {
  ...
  # If no offspring, save results and stop simulation
    ...
    warning(sprintf("Simulation stopped early at generation %d due to extinction (no offspring)", G))
      ...
      save(prey_res, file = "~/H/GitHub/ballistic-movement/sim_results/June6_lv_Evo_30000g_5cal_prey_res.Rda")
      save(prey_details, file = "~/H/GitHub/ballistic-movement/sim_results/June6_lv_Evo_30000g_5cal_prey_details.Rda")
