...
load("H:/GitHub/ballistic-movement/sim_results/constant_resources_nopred_varycalories/June6_lv_Evo_1000g_3cal_prey_details.Rda")
load("H:/GitHub/ballistic-movement/sim_results/constant_resources_nopred_varycalories/June6_lv_Evo_1000g_3cal_prey_res.Rda")
