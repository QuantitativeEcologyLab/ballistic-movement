...
* `simulations/` contains the .simulation outputs as `.Rda` files, as well as specialized results from supplementary and sensitivity analyses, except when files are too large to store on GitHub.
* `figures/` contains all figures of simulation results, including sensitivity, supplementary, and main text.
